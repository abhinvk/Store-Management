...
<head>
    ...
    <title><?php echo ucwords(str_replace('_','',$page)) ?> | Provisional Store Management </title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="https://app.droxy.ai/guest-chatbot/65eb74c14b635fdac3398145">Customer Support(Innovative)</a>
                    </li>
                    <li class="nav-item">
