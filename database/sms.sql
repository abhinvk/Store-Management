...
INSERT INTO `customer_list` (`customer_id`, `name`, `email`, `phone`, `address`, `date_added`) VALUES
(1, 'John Doe', 'john@example.com', '1234567890', '123 Main St, Cityville', '2022-02-14 03:30:00'),
(2, 'Jane Smith', 'jane@example.com', '9876543210', '456 Oak St, Townsville', '2022-02-14 03:35:00');
...
INSERT INTO `supplier_list` (`supplier_id`, `name`, `email`, `phone`, `address`, `date_added`) VALUES
(1, 'ABC Supplier', 'abc@example.com', '1112223333', '789 Market St, Villagetown', '2022-02-14 03:45:00'),
(2, 'XYZ Supplier', 'xyz@example.com', '4445556666', '101 Pine St, Hilltop', '2022-02-14 03:50:00');
...
--
ALTER TABLE `customer_list`
  MODIFY `customer_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `supplier_list`
--
ALTER TABLE `supplier_list`
  MODIFY `supplier_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `customer_list`
  ADD CONSTRAINT `customer_list_ibfk_1` PRIMARY KEY (`customer_id`);

--
-- Constraints for table `supplier_list`
--
ALTER TABLE `supplier_list`
  ADD CONSTRAINT `supplier_list_ibfk_1` PRIMARY KEY (`supplier_id`);
