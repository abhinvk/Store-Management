...
while ($row = $qry->fetch_assoc()) {
    ...
    $dataPoints1[] = array("label" => date("Y", strtotime($row['date_added'])), "y" => $items);
    $dataPoints2[] = array("label" => date("Y", strtotime($row['date_added'])), "y" => $row['total']);
}
?>
            ...
            <table class="table table-hover table-striped table-bordered">
                ...
                while ($row = $qry->fetch_assoc()):
                    ...
                    <tr>
                        ...
                        <td class="py-0 px-1"><a href="javascript:void(0)"
                                                  class="view_data"
                                                  data-id="<?php echo $row['transaction_id'] ?>"><?php echo $row['receipt_no'] ?></a>
                        </td>
                ...
                <?php if ($qry->num_rows <= 0): ?>
                    <th colspan="6"><center>No Transaction listed in the selected date.</center></th>
                <?php else: ?>
                    <tr>
                        <td colspan="4" class="text-end p-0"><b>Total Amount:</b></td>
                        <td class="text-end p-0"><b><?php echo format_num($totalAmount) ?></b></td>
