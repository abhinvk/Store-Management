...
<head>
    ...
    <title>LOGIN | Provisional Store Management </title>
...
<body class="">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h1 class="py-5 text-center text-light px-4" id="sys_title">Provisional Store Management </h1>
...
<script>
    $(function(){
        $('#login-form').submit(function(e){
            ...
            // Continue with AJAX request if the username is a valid email
            $.ajax({
